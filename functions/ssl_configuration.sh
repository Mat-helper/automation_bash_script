...
generate_ssl_keys ()
{
    ...
    sudo sed -i '12 i Redirect permanent / https://PH_FLQN_NAME/ ' ${HTTP_CONF_DIR_AVAILABLE_SITES}/${APACHE2_CONF_SITE_DEFAULT}
    ...
    sudo sed -i '6d' ${HTTP_CONF_DIR_AVAILABLE_SITES}/${APACHE2_CONF_SITE_DEFAULT_SSL}
